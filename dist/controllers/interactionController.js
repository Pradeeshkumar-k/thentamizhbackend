...
exports.likeNovel = likeNovel;
// Unlike a Novel
const unlikeNovel = async (req, res) => {
    try {
        const { novelId } = req.body;
        const userId = req.user?.userId;
        if (!userId) {
...
exports.unlikeNovel = unlikeNovel;
// Bookmark a Novel
const bookmarkNovel = async (req, res) => {
    try {
        const { novelId } = req.body;
        const userId = req.user?.userId;
        if (!userId) {
...
exports.bookmarkNovel = bookmarkNovel;
...
exports.getBookmarkedNovels = getBookmarkedNovels;
